...
class FastingTimer {
    ...
    init() {
        ...
        this.soundCheckBtn.addEventListener('click', () => this.playNotificationSound());
    ...
    startTimer() {
        ...
        // ユーザーインタラクションがあったタイミングでAudioContextを準備
        this.prepareAudio();
    }
    ...
    startTestMode() {
        ...
        // 現在のtotalDuration（分母）は変えず、残り時間だけ60秒にする
        // これにより、グラフが「終わりに近づいている」見た目になる
