...
function applyPreviewStyles() {
    // 重要: 角丸はコンテナ自体(#slider-preview-container)に適用します。
    // これにより、overflow: hidden が正しく機能し、背景も正しくクリップされます。
    // We apply border-radius to the container element to ensure proper clipping.
    if (elements.previewContainer) {
        elements.previewContainer.style.borderRadius = config.borderRadius + 'px';
    }
}
...
<style>
    ...
    #${uniqueId} {
        ...
        aspect-ratio: 16/9;
        /* 背景を完全に透過 / Transparent background */
