// ==========================================
// Cinema Roulette Pro V2 - Main Script
// 初心者学習用コメント付き
// ==========================================
...
const resultTitle = document.getElementById('resultTitle'); // V2: タイトル変更用
const resultContent = document.getElementById('resultContent');
const searchLink = document.getElementById('searchLink'); // V2: 表示制御用
...
function loadTheme() {
    ...
    // デフォルトはダーク（savedThemeがnullの時はfalse）
    // savedThemeが 'light' なら true
...
function showWinner(movie) {
    ...
    searchLink.style.display = 'inline-block'; // 表示を戻す
